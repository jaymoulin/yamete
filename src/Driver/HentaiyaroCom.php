...
class HentaiyaroCom extends \Yamete\DriverAbstract
{
    private $aMatches = [];
    const DOMAIN = 'hentaiyaro.com';
    ...
    public function getDownloadables(): array
    {
        ...
        foreach ($this->getDomParser()->load((string)$oRes->getBody())->find('li.wp-manga-chapter a') as $oLink) {
            ...
            foreach ($this->getDomParser()->load((string)$oRes->getBody())->find('.read-container img') as $oImg) {
